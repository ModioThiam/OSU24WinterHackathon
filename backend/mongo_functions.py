...
cluster = MongoClient("mongodb+srv://testUser1:srwJBVVqicTVLHVo@cluster0.ztll2xp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = cluster["BookApp"]
collection = db["users"]
...
def log_book(user_name, title, author, year, genre, tags=None):
    ...
    if not res:
        collection.insert_one({"user_name":user_name, "books":[{"title": title, "author": author, "year": year, "genre": genre, "tags": tags}]})
